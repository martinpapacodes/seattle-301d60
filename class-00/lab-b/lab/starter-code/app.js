...
// Refers to the instance created in let joe = new Student('Joe', 'Schmoe', 100);
// 2. What is "this" when joe.scopeArrow() is invoked?
// Refers to the Window object
// 3. Explain why "this" is different when an arrow function is used.
// Because this keyword does not refer to the Student object when using arrow functions. It will always refer to the parent, which is the Window object.
